...
### 一、用默认配置编译一遍内核，将新的内核替换现有内核

#### 树莓派本地编译

1. 获取源码  
	下载地址：[https://github.com/raspberrypi](https://github.com/raspberrypi)  
...
4. 编译  
	...
	编译完成  
	![14](14.png)  
	问题： fatal error: openssl/bio.h: 没有那个文件或目录  
	![15](15.png)  
...
1. 裁剪内核  
	...
	11. Device Drivers --> Input device support  
		...
		不使用触摸屏  
		(M=>N)  
	12. Device Drivers > Character devices   
		![59](59.png)  
		基于硬件的“可信赖平台模块”。在一般情况下，建议选择N。  
	13. Device Drivers --> Input device support  
		![60](60.png)  
		不使用游戏杆  
2. 编译  
	`KERNEL=kernel7 make -j4 zImage modules dtbs`   
